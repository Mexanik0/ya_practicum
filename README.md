...
- Отработка навыков работы с тетрадкой в Jupyter Notebook и основными библиотеками для аналитики (pandas, matplotlib, numPy, sciPy, seaborn);
- Решение задач на SQL. Отработка навыков написания простых и сложных запросов (использование оконных функций, подзапросов, CTE-выражений).
...
|  2  |  Проект по SQL |  Предлагалось решить 5 задач с помощью SQL, чтобы сформулировать предложение для нового сервиса для чтения книг по подписке.  |  `SQL` `PostgreSQL` `sqlalchemy` |  Интернет-сервисы |
